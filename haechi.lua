local Haechi = getgenv().Haechi or {}
local config = {
    autoskip = Haechi.autoskip or false,
    SellAllTower = Haechi.SellAllTower or false,
    AtWave = Haechi.AtWave or 0,
    autoCommander = Haechi.autoCommander,
    difficulty = Haechi.Difficulty,
    map = Haechi.Map,
    replay = Haechi.Replay,
    macroURL = Haechi.MarcoUrl or "https://example.com/mymacro.lua"
}
